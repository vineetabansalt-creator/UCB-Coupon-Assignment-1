...
**Overall acceptance rate: ~57%**” more than half of drivers accept a coupon when presented with one, but acceptance varies widely based on context.

### Bar Coupons (41% acceptance)
- Drivers who already visit bars frequently (3+ times/month) accepted at **77%**” nearly double the overall bar rate
...
- The best time window is **10AM “2PM**” acceptance peaks during the natural coffee break hours
- Regular coffee drinkers (1“3x/month+) accepted at significantly higher rates than non-visitors
- **1-day expiration outperforms 2-hour**” more time flexibility means more acceptances
...
1. **Target existing behavior**” the strongest predictor across all coupon types is whether the driver already visits that venue. Coupons are most effective as reinforcement, not habit creation.
2. **Match timing to the coupon type**” coffee in the morning, bars in the evening.
3. **Avoid families for bar coupons**” presence of kids is a consistent negative signal.
